...
I used it to make myself more familiar with using off the shelf rails gems such as:
...
Probably one of my simplest experiments, but I'm proud of it since it only took a few hours to get it all working!
